  ...
  return (
    <div className="grid grid-cols-2 bg-matasPink-700 rounded-md overflow-hidden gap-4 min-h-full ">
      ...
      <div className={`${styles.textContainer}`}>
        <div>
          <h2 className="text-matasBlue-900 text-xs sm:text-xl lg:text-base">
            DAGCREME
          </h2>
          <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl text-matasBlue-900 font-serif font-semibold mt-2 ">
            TIP
          </h1>
          <p className="max-w-[300px] mt-2 text-xs sm:text-base lg:text-base	">
